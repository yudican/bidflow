    ...
    <table width="100%;">
      <tr>
        ...
        <td style="text-align: right">
          @if ($data->resi)
          <img
            src="data:image/png;base64,{!!DNS1D::getBarcodePNG($data->resi, 'C39', 1, 80, [1,1,1],true)!!}"
            alt=""
          />
          @else
    ...
    <table width="100%;">
      <tr>
        <td align="left">
          ...
          <strong>{{@$address->telepon}}</strong
          ><br />
          <strong>{{@$address->nama}}</strong
          ><br />
        ...
        <td style="text-align: right">
          ...
          <strong>{{@$data->brand->phone}}</strong
          ><br />
