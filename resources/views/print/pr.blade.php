    ...
    mso-border-top-alt:solid windowtext .5pt;padding:0cm 5.4pt 0cm 5.4pt'>
          ...
          <tr style='mso-yfti-irow:14;height:12.55pt'>
            ...
            <td width=116 colspan=2 valign=top style='width:87.15pt;border:none;padding:0cm 5.4pt 0cm 5.4pt;height:12.55pt'>
              <!-- verified by -->
              @if ($data->approvalLeads[0]->label == 'Verified by' && $data->approvalLeads[0]->status == '1' && $data->request_status != '3')
              <center>
                <p class=MsoNormal><span lang=EN-US style='mso-ansi-language:EN-US'>
                    <o:p><img src="{{asset('assets/img/confirmed.png')}}" style="height:50px; margin-right: 10px;" alt=""></o:p>
                  </span></p>
            ...
            <td width=102 colspan=2 valign=top style='width:76.15pt;border:none;padding:0cm 5.4pt 0cm 5.4pt;height:12.55pt'>
              <!-- Approved by edward -->
              @if ($data->approvalLeads[1]->label == 'Approved by' && $data->approvalLeads[1]->status == '1' && $data->request_status != '3')
              <center>
                <p class=MsoNormal><span lang=EN-US style='mso-ansi-language:EN-US'>
                    <o:p><img src="{{asset('assets/img/confirmed.png')}}" style="height:50px; margin-right: 10px;" alt=""></o:p>
                  </span></p>
            ...
            <td width=101 colspan=2 valign=top style='width:76.1pt;border:none;padding:0cm 5.4pt 0cm 5.4pt;height:12.55pt'>
              <!-- Approved by dennis -->
              @if ($data->approvalLeads[2]->label == 'Approved by' && $data->approvalLeads[2]->status == '1' && $data->request_status != '3')
              <center>
                <p class=MsoNormal><span lang=EN-US style='mso-ansi-language:EN-US'>
                    <o:p><img src="{{asset('assets/img/confirmed.png')}}" style="height:50px; margin-right: 10px;" alt=""></o:p>
                  </span></p>
            ...
            <td width=101 colspan=2 valign=top style='width:76.1pt;border:none;padding:0cm 5.4pt 0cm 5.4pt;height:12.55pt'>
              <!-- Approved by all -->
              @if ($data->approvalLeads[0]->status == '1' && $data->approvalLeads[1]->status == '1' && $data->approvalLeads[2]->status == '1' && $data->approvalLeads[3]->status == '1' && $data->request_status != '3')
              <center>
                <p class=MsoNormal><span lang=EN-US style='mso-ansi-language:EN-US'>
                    <o:p><img src="{{asset('assets/img/confirmed.png')}}" style="height:50px; margin-right: 10px;" alt=""></o:p>
                  </span></p>
