            ...
            <tr>
                <td rowspan="2" width=94 valign=top style='width:70.85pt;border:solid windowtext 1.0pt;padding:0in 5.4pt 0in 5.4pt'>
                    @if(isset($data->logo) && $data->logo)
                        <img src="{{ $data->logo }}" alt="Logo" style="height:50px; margin-right: 10px;">
                    @else
                        <img src="{{asset('assets/img/logo-new.png')}}" style="height:50px; margin-right: 10px;" alt="">
                    @endif
                </td>
                <td width=180 valign=middle style='width:134.7pt;border:solid windowtext 1.0pt;border-left:none;padding:0in 5.4pt 0in 5.4pt'>
                    <p class=MsoNormal style='margin-top:7.8pt'><b><span style='font-size:12.0pt;font-family:"Arial MT",sans-serif'>{{$data->pt_name}}</span></b></p>
                </td>
            </tr>
            <tr>
