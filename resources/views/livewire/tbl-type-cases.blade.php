<div class="page-inner">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <x-text-field type="text" name="type_name" label="Type Name" />
                    <x-text-field type="text" name="code" label="Code" />
            ...
            @else
            <livewire:table.type-case-table params="{{$route_name}}" />
            @endif
