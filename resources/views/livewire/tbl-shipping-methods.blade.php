<div class="page-inner">
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <span>{{ ($form_active)?'Form Pengisian Data Shipping':'List Data Shipping' }}</span>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <x-text-field type="text" name="code" label="Kode Shipping" placeholder="Masukkan kode shipping" isreq="*" />
                    <x-text-field type="text" name="name" label="Nama Shipping" placeholder="Masukkan nama shipping" isreq="*" />
            ...
            @else
            <livewire:table.shipping-method-table params="{{$route_name}}" />
            @endif
