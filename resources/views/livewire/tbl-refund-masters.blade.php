                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span>refund masters</span>
                        </a>
                        <div class="pull-right">
                            @if ($form_active)
                            <button class="btn btn-danger btn-sm" wire:click="toggleForm(false)"><i class="fas fa-times"></i> Cancel</button>
                            @else
                            @if (in_array(auth()->user()->role->role_type, ['cs', 'leadcs', 'superadmin']))
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                                ...
                                <div class="col-md-6 col-lg-6" style="line-height: 36px;">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3 col-lg-3" style="line-height: 36px;">
                                            <x-text-field type="text" name="ext" label="Handphone" isreq="*" readonly />
                                        </div>
                                        <div class="col-md-9 col-lg-9" style="line-height: 36px;">
                                            <x-text-field type="text" name="handphone" label="." />
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6 col-lg-6" style="line-height: 36px;">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12 col-lg-12" style="line-height: 36px;">
                                    ...
                                    <x-input-photo foto="{{$transfer_photo}}" path="{{optional($transfer_photo_path)->temporaryUrl()}}" name="transfer_photo_path" label="Transfer Photo " isreq="*" />
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-lg-12" style="line-height: 36px;">
                                    <table class="display table table-striped table-hover" id="resi-pengembalian">
                                        ...
                                        <tbody>
                                            @if (count($refundresi) > 0)
                                            @foreach ($refundresi as $key => $res)
                    ...
                    @if ($update_mode && $status == 0 && in_array(auth()->user()->role->role_type, ['adminsales', 'leadwh', 'superadmin', 'leadsales', 'warehouse', 'admindelivery']))
                    <div class="form-group">
                        <button class="btn btn-danger pull-right" wire:click="approval('{{$uid_refund}}',2)">Reject</button>
                        <button class="btn btn-primary pull-right" style="margin-right: 10px" wire:click="approval('{{$uid_refund}}',1)">Terima Refund</button>
                    </div>
                    ...
                    <div class="form-group">
                        <button class="btn btn-danger pull-right" wire:click="approval('{{$uid_refund}}',3)">Konfirmasi Refund Selesai</button>
                    </div>
                    @endif
                </div>
            </div>
            @else
            <livewire:table.refund-master-table params="refund-master" />
            @endif
            ...
            <div class="modal-dialog" permission="document">
                <div class="modal-content {{ $is_dark_mode ? 'bg-black' : 'bg-white' }}">
                    ...
                    <div class="modal-body">
                        ...
                        <input type="hidden" wire:model="uid_refund" id="uid_refund" />
