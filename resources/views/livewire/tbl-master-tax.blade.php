<div class="page-inner">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <x-text-field type="text" name="tax_code" label="Tax Code" />
                    <x-text-field type="text" name="tax_percentage" label="Tax Percentage" />
            ...
            @else
            <livewire:table.master-tax-table params="{{$route_name}}" />
            @endif
