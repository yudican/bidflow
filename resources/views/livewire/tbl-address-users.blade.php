<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3 text-capitalize"></i>address users</span>
                        </a>
        ...
        <div class="col-md-12">
            <livewire:table.address-table params="{{$route_name}}" />
        </div>
            ...
            <div class="modal-dialog" permission="document">
                <div class="modal-content {{ $is_dark_mode ? 'bg-black' : 'bg-white' }}">
                    <div class="modal-header {{ $is_dark_mode ? 'bg-black' : 'bg-white' }}">
                        <h5 class="modal-title text-capitalize" id="my-modal-title">{{$update_mode ? 'Update' : 'Tambah'}} address users</h5>
                    ...
                    <div class="modal-body">
                        ...
                        <x-text-field type="text" name="provinsi_id" label="Provinsi Id" />
                        <x-text-field type="text" name="kabupaten_id" label="Kabupaten Id" />
                        <x-text-field type="text" name="kecamatan_id" label="Kecamatan Id" />
                        <x-text-field type="text" name="kelurahan_id" label="Kelurahan Id" />
