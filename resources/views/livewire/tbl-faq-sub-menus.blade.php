<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span>{{ ($form_active)?'Form Pengisian Data Faq Submenu':'List Data Faq Submenu' }}</span>
                        </a>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <x-text-field type="text" name="sub_menu" label="Sub Menu" isreq="*" />
            ...
            @else
            <livewire:table.faq-submenu-table params="{{$route_name}}" />
            @endif
