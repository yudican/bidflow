<div class="page-inner">
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <span>{{ ($form_active)?'Form Pengisian Data Kategori':'List Data Kategori' }}</span>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <x-text-field type="text" name="name" label="Nama Kategori" placeholder="Masukkan nama kategori" isreq="*" />
            ...
            @else
            <livewire:table.category-table params="{{$route_name}}" />
            @endif
