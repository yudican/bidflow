<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3"></i>Detail Variants</span>
                        </a>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <x-select name="variant_id" label="Variant">
                        <option value="">Select Variant</option>
                    </x-select>
                    <x-text-field type="text" name="name" label="Detail Variant Name" />
            ...
            @else
            <livewire:table.detail-variant-table params="{{$route_name}}" />
            @endif
