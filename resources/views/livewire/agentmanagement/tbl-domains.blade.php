<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3"></i>List Domain</span>
                        </a>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <x-input-photo foto="{{$icon}}" path="{{optional($icon_path)->temporaryUrl()}}" name="icon_path" label="Icon" />
                    <x-text-field type="text" name="url" label="Url" />
                    <x-text-field type="text" name="fb_pixel" label="Fb Pixel" />
            ...
            @else
            <livewire:table.domain-table params="{{$route_name}}" />
            @endif
        ...
        {{-- Modal confirm --}}
        <div id="domain-modal" wire:ignore.self class="modal fade" tabindex="-1" permission="dialog" aria-labelledby="my-modal-title" aria-hidden="true">
            <div class="modal-dialog modal-lg" permission="document">
                <div class="modal-content {{ $is_dark_mode ? 'bg-black' : 'bg-white' }}">
                    <div class="modal-header {{ $is_dark_mode ? 'bg-black' : 'bg-white' }}">
                        <h5 class="modal-title" id="my-modal-title">Management Agent</h5>
                    </div>
                    <div class="modal-body">
                        <livewire:table.agent-domain-table params="{{$route_name}}" />
                    </div>
                    <div class="modal-footer">
    ...
    <script>
        $(document).ready(function(value) {
            ...
            window.livewire.on('showAgentModal', (data) => {
                $('#domain-modal').modal(data)
            });
