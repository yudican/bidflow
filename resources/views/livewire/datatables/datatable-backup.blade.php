        ...
        <div class="flex justify-between items-center mb-1">
            <div class="flex-grow h-10 flex items-center mt-3 mb-1">
                ...
                <div class="w-96 flex rounded-lg shadow-sm mb-3 dark">
                    <div class="relative flex-grow focus-within:z-10">
                        ...
                        <input wire:model.debounce.500ms="search" class="w-full pl-10 py-3 text-sm leading-4 block rounded-md border-gray-300 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 focus:outline-none bg-transparent" placeholder="{{__('Cari Disini')}}" type="text" />
            ...
            <div class="dropdown show">
                ...
                <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                    ...
                    <div>
                        @if (in_array($role,['warehouse','admindelivery','superadmin','adminsales']))
                    ...
                    <div>
                        @if (in_array($role,['warehouse','admindelivery','superadmin']))
