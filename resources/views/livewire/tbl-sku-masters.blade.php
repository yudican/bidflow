<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3"></i>tbl sku masters</span>
                        </a>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <x-text-field type="text" name="sku" label="Sku Master" />
                    <x-select name="package_id" label="Package">
            ...
            @else
            <livewire:table.sku-master-table params="{{$route_name}}" />
            @endif
