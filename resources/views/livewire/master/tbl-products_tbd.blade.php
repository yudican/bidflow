<div class="page-inner">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <x-text-field type="text" name="nama_product" label="Nama Product" />
                    <x-text-field type="number" name="harga_product" label="Harga Product" />
                    <x-input-photo foto="{{$gambar_produk}}" path="{{optional($gambar_produk_path)->temporaryUrl()}}" name="gambar_produk_path" label="Gambar Produk" />
                    <x-select name="category_id" label="Category Id">
                        <option value="">Select Category Id</option>
                        @foreach ($categories as $category)
                        <option value="{{$category->id}}">{{$category->nama_kategori}}</option>
                        @endforeach
                    </x-select>
                    <x-textarea type="text" name="deskripsi" label="Deskripsi" />
