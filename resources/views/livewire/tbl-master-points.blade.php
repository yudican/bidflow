<div class="page-inner">
    <div class="row">
            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <span>{{ ($form_active)?'Form Pengisian Data Point':'List Data Point' }}</span>
        ...
        <div class="col-md-12">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col">
                            @if ($type == 'transaction')
                            <div>
                                <x-text-field type="text" name="point" label="Point" placeholder="Masukkan jumlah poin" />
                                <x-text-field type="text" name="min_trans" label="Min Transaksi" placeholder="Masukkan jumlah minimum Transaksi (Rp)" />
                                <x-text-field type="text" name="max_trans" label="Max Transaksi" placeholder="Masukkan jumlah maksimum Transaksi (Rp)" />
                            </div>
                            @else
                            <div>
                                <x-text-field type="text" name="point" label="Point" placeholder="Masukkan jumlah poin" />
            ...
            @else
            <livewire:table.master-point-table params="{{$route_name}}" />
            @endif
