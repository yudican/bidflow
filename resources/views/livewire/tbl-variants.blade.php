            ...
            <div class="card">
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <span>{{ ($form_active)?'Form Pengisian Data Variant':'List Data Variant' }}</span>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <div class="row">
                        <div class="col">
                            <x-text-field type="text" name="name" label="Nama Varian" placeholder="Masukkan nama varian" isreq="*" />
                        </div>
                        <div class="col">
                            <x-text-field class="col" type="text" name="slug" label="Slug (otomatis)" readonly />
                        </div>
                    </div>
            ...
            @else
            <livewire:table.variant-table params="{{$route_name}}" />
            @endif
