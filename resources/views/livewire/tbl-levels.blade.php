                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span><i class="fas fa-arrow-left mr-3"></i>{{ ($form_active)?'Form Pengisian Data Level':'List Data Level' }}</span>
                        </a>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <x-text-field type="text" name="description" label="Description" />
                    <x-select name="status" label="Status">
                        <option value="">Select Status</option>
                    </x-select>
                    <x-select name="role_id" label="Role" multiple ignore>
            ...
            @else
            <livewire:table.level-table params="{{$route_name}}" />
            @endif
