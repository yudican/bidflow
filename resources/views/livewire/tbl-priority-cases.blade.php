<div class="page-inner">
    <div class="row">
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <x-text-field type="text" name="priority_name" label="Priority Name" />
                    <x-text-field type="number" name="priority_day" label="Priority Day" />
                    <x-text-field type="text" name="notes" label="Notes" />
            ...
            @else
            <livewire:table.priority-case-table params="{{$route_name}}" />
            @endif
