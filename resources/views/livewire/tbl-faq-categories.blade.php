<div class="page-inner">
    <div class="row">
                ...
                <div class="card-body">
                    <h4 class="card-title text-capitalize">
                        <a href="{{route('dashboard')}}">
                            <span>{{ ($form_active)?'Form Pengisian Data Faq Categories':'List Data Faq Categories' }}</span>
                        </a>
        ...
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="card-body">
                    <x-text-field type="text" name="category" label="Category" isreq="*" />
            ...
            @else
            <livewire:table.faq-category-table params="{{$route_name}}" />
            @endif
