...
import { OrderAcceptedListColumn } from "./config"

const OrderAcceptedList = () => {
  ...
  const loadContact = (url = "/api/orderAcceptedAgent", perpage = 10) => {
    setLoading(true)
  ...
  return (
    <Layout
      ...
      title="Transaction Agent - Pesanan Diterima"
    >
      <div className="card">
        <div className="card-body">
          <Table
            dataSource={contacts}
            columns={OrderAcceptedListColumn}
            loading={loading}
            pagination={false}
            rowKey="id"
