...
import { ConfirmationAgentListColumn } from "./config"
...
const AllTransList = () => {
  ...
  const loadContact = (url = "/api/confirmationAgent", perpage = 10) => {
    setLoading(true)
  ...
  return (
    <Layout
      ...
      title="Transaction Agent - Perlu Dikonfirmasi"
    >
      <div className="card">
        <div className="card-body">
          <Table
            dataSource={contacts}
            columns={ConfirmationAgentListColumn}
            loading={loading}
            pagination={false}
            rowKey="id"
