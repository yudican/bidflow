...
export const searchBin = async (search, params = null, limit = 5) => {
  return await axios
    .post(`/api/general/search-bin`, { search, params, limit })
    .then((res) => res.data.data)
}

export const handleSearchBin = async (e, params = null) => {
  return searchBin(e, params).then((results) => {
