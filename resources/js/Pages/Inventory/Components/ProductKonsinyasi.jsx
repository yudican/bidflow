...
import { productListKonsColumns } from "../config"
import ModalProduct from "../../../components/Modal/ModalProduct"

const ProductKonsinyasi = ({
  products = [],
  handleChange,
  handleClick,
  onChange,
  ...
  const mergedColumns = productListKonsColumns.map((col) => {
    return {
      ...col,
      onCell: (record) => ({
        record,
  ...
  return (
    <div>
      ...
      {/* when disabled, add more button disappear */}
      {!disabled && (
        <div
          onClick={() => {
            if (disabled) {
      ...
      return (
        <td>
          <ModalProduct
            products={products}
            disabled={disabled}
            productNeedSelected={selectedProduct}
            stock={stock}
            handleChange={(e) =>
              handleChange({
                value: e,
...
export default ProductKonsinyasi
