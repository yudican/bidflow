    ...
    <div>
      ...
      >
        <div>
          ...
          <div>
            <label htmlFor="">Status Ethix</label>
            <Select
              mode="multiple"
              allowClear
              className="w-full mb-2"
              placeholder="Pilih Status"
              onChange={(e) => handleChange(e, "status_ethix")}
            >
              <Select.Option key={1} value={"submited"}>
                Submitted
              </Select.Option>
              <Select.Option key={0} value={"notsubmited"}>
                Not Submitted
              </Select.Option>
            </Select>
          </div>
          <div>
            <label htmlFor="">Status GP</label>
            <Select
              mode="multiple"
              allowClear
              className="w-full mb-2"
              placeholder="Pilih Status"
              onChange={(e) => handleChange(e, "status_gp")}
            >
              <Select.Option key={1} value={"submited"}>
                Submitted
              </Select.Option>
          ...
          <div>
            ...
            <RangePicker
              ...
              onChange={(e, dateString) => {
                handleChange(dateString, "trx_date")
              }}
            />
          </div>
        </div>
