...
const StockAwalAccurate = () => {
    ...
    const getStockOpnames = ({ page = 1, per_page = 10, keyword = "" } = {}) => {
        setLoading(true)
        fetch(`/api/accurate/stock-opname/accurate/data?page=${page}&per_page=${per_page}&search=${keyword}`)
            .then((res) => res.json())
            .then((json) => {
                setData(json.data || {})
            })
...
export default StockAwalAccurate
