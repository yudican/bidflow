          ...
          <table className="w-100" style={{ width: "100%" }}>
            <tbody>
              ...
              <tr>
                ...
                <td>: {(order?.order_type === 'new' ? 'Data Baru' : order?.order_type ? 'Data Lama' : "-")}</td>
              </tr>
            </tbody>
          </table>
        </div>
        <div className="col-md-6">
          <table className="w-100" style={{ width: "100%" }}>
            <tbody>
              ...
              <tr>
                <td style={{ width: "40%" }} className="py-2">
                  <strong>Destinasi BIN</strong>
                </td>
                <td>: {handleString(order?.master_bin_name) || "-"}</td>
              </tr>
              <tr>
                <td style={{ width: "40%" }} className="py-2">
              ...
              <tr>
                ...
                <td>
                  {order?.invoice_date ? (
                    ...
                    <Tooltip title="Silahkan Input Pengiriman Terlebih Dahulu">
                      <span>: -</span>
                    </Tooltip>
                  )}
                </td>
