...
const OrderManualLeadList = () => {
  ...
  const menu = (
    <Menu>
      ...
      <Menu.Item>
        <ModalOrderExport formData={{ ...filterData, type: "konsinyasi" }} />
      </Menu.Item>
      <Menu.Item>
  ...
  const rightContent = (
    <div className="flex justify-between items-center">
      ...
      {show && (
        <button
          onClick={() => navigate("/order/order-konsinyasi/form")}
  ...
  return (
    <Layout rightContent={rightContent} title="List Order Konsinyasi">
      <div className="card">
