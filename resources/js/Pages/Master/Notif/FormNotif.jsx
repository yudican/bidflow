...
const FormNotif = () => {
  ...
  const loadDetailNotif = () => {
    axios.get(`/api/master/notification/${notif_id}`).then((res) => {
      const { data } = res.data
  ...
  const onFinish = (values) => {
    ...
    const url = notif_id
      ? `/api/master/notification/save/${notif_id}`
      : "/api/master/notification/save"
    ...
    axios
      ...
      .then((res) => {
        ...
        return navigate("/master/notification")
      })
      .catch((err) => {
            ...
            <div className="col-md-6">
              <Form.Item
                ...
                rules={[
                  {
                    required: true,
                    message: "Silakan masukkan Nama Notif!",
                  },
                ]}
              >
                <Input placeholder="Ketik Notif Alert" />
              </Form.Item>
            </div>
            <div className="col-md-6">
              <Form.Item
