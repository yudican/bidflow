...
import { Dropdown, Input, Menu, Pagination, Switch, Table } from "antd"
...
const MasterSiteIDList = () => {
  ...
  const handleChange = (page, pageSize = 10) => {
    loadData(`/api/master/site-id/?page=${page}`, pageSize, {
      search,
      page,
      ...filterData,
    })
  ...
  const handleChangeSearch = () => {
    setIsSearch(true)
    loadData(`/api/master/site-id`, 10, { search })
  }

  const handleFilter = (data) => {
    setFilterData(data)
    loadData(`/api/master/site-id`, 10, data)
  }

  const updateStatus = (record) => {
    axios
      .post(`/api/master/site-id/save/${record.id}`, record)
      .then((res) => {
  ...
  return (
    <Layout rightContent={rightContent} title="List Master Site ID">
      <div className="card">
...
export default MasterSiteIDList
