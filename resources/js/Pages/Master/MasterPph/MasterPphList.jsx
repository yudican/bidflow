...
const MasterPphList = () => {
  ...
  const handleChange = (page, pageSize = 10) => {
    loadData(`/api/master/master-pph/?page=${page}`, pageSize, {
      search,
      page,
      ...filterData,
    })
  ...
  const handleChangeSearch = () => {
    setIsSearch(true)
    loadData(`/api/master/master-pph`, 10, { search })
  }

  const handleFilter = (data) => {
    setFilterData(data)
    loadData(`/api/master/master-pph`, 10, data)
  }

  const deletePaymentTermId = (payment_term_id) => {
    axios
      .post(`/api/master/master-pph/delete/${payment_term_id}`, {
        _method: "DELETE",
      })
      .then((res) => {
  ...
  return (
    <Layout rightContent={rightContent} title="List Master PPH 21">
      <div className="card">
