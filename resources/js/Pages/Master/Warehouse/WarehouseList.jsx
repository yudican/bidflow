...
const WarehouseList = () => {
  ...
  const handleChange = (page, pageSize = 10) => {
    loadData(`/api/master/warehouse/?page=${page}`, pageSize, {
      search,
      page,
      ...filterData,
    })
  ...
  const handleChangeSearch = () => {
    setIsSearch(true)
    loadData(`/api/master/warehouse`, 10, { search })
  }

  const handleFilter = (data) => {
    setFilterData(data)
    loadData(`/api/master/warehouse`, 10, data)
  }

  const deleteTypeCase = (warehouse_id) => {
    axios
      .post(`/api/master/warehouse/delete/${warehouse_id}`, {
        _method: "DELETE",
      })
      .then((res) => {
  ...
  const updateStatus = (record) => {
    axios
      .post(`/api/master/warehouse/save/${record.id}`, record)
      .then((res) => {
  ...
  return (
    <Layout rightContent={rightContent} title="List Warehouse">
      <div className="card">
