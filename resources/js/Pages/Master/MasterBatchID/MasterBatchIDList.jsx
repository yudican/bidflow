...
const MasterBatchIDList = () => {
  ...
  const handleChange = (page, pageSize = 10) => {
    loadData(`/api/master/batchId/?page=${page}`, pageSize, {
      search,
      page,
      ...filterData,
    })
  ...
  const handleChangeSearch = () => {
    setIsSearch(true)
    loadData(`/api/master/batchId`, 10, { search })
  }
  ...
  return (
    <Layout rightContent={rightContent} title="List Master Batch ID">
      <div className="card">
...
export default MasterBatchIDList
