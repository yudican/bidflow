...
const EthixOrderSubmitList = () => {
  ...
  return (
    <Layout rightContent={rightContent} title="List Submit SI">
      <div className="card">
            ...
            columns={[
              ...orderSubmitColumn,
              {
                ...
                render: (text, record) => {
                  return (
                    <button
                      className="ml-3 text-white bg-blue-800 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 text-center inline-flex items-center mr-2"
                      onClick={() =>
                        navigate(`/order/submit/history/${record.id}`)
                      }
                    >
...
export default EthixOrderSubmitList
