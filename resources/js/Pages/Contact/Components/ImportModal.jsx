...
import ModalImportContactConfirm from "../../../components/Modal/ModalImportContactConfirm"
...
const ImportModal = ({ handleOk }) => {
  ...
  const handleOkAndImport = () => {
    ...
    axios
      .post("/api/contact/import", formData)
      .then((response) => {
      ...
      >
        <div className="w-full">
          <p className="alert alert-info">
            ...
            dengan klik{" "}
            <a href="/assets/template/import-contact.xlsx" download>
              Download Template
            </a>
          </p>
          <ModalImportContactConfirm
            refetch={() => handleOk({})}
            onLoad={(data) => setDisableButton(data)}
          />
          {/* <Form
            form={form}
            name="basic"
