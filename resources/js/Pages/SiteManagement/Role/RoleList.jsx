...
import { roleListColumn } from "./config"
...
const RoleList = () => {
  ...
  const handleChange = (page, pageSize = 10) => {
    loadData(`/api/site-management/role/?page=${page}`, pageSize, {
      search,
      page,
      ...filterData,
    })
  ...
  const handleChangeSearch = () => {
    setIsSearch(true)
    loadData(`/api/site-management/role`, 10, { search })
  }

  const handleFilter = (data) => {
    setFilterData(data)
    loadData(`/api/site-management/role`, 10, data)
  }

  const deleteCategory = (category_id) => {
    axios
      .post(`/api/site-management/role/delete/${category_id}`, {
        _method: "DELETE",
      })
      .then((res) => {
