            ...
            datas.forEach((item) => {
                ...
                if (tax) {
                    ...
                    if (tax.tax_percentage > 0) {
                        ...
                        updatedData["total"] =
                            taxAmount +
                            parseInt(priceNego > 0 ? priceNego - discountAmount : subtotalPrice - discountAmount);
                    } else {
                        updatedData["tax_percentage"] = 0;
                        updatedData["tax_amount"] = 0;
                        updatedData["total"] = parseInt(
                            priceNego > 0 ? priceNego - discountAmount : subtotalPrice - discountAmount
                        );
                    }
                }
    ...
    return (
        <ProductList
            ...
            summary={(currentData) => {
                ...
                const qty = currentData.reduce(
                    (acc, curr) => parseInt(acc) + parseInt(curr.qty || 0),
                    0
                )
                return (
                    <Table.Summary>
