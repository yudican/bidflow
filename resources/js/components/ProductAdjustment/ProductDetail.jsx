...
import { productListDetColumns } from "./config"
...
const ProductDetail = ({
    ...
    const mergedColumns = productListDetColumns.map((col) => {
        return {
            ...col,
            onCell: (record) => ({
                record,
...
const EditableCell = (props) => {
    ...
    if (record) {
        ...
        if (dataIndex === "stock_awal") {
            console.log("masuk stock")
            return (
                <td>
                    <Input
                        disabled={true}
                        ...
                        onBlur={() => {
                            ...
                            handleChange({
                                value: parseInt(finalValue, 10) || 0,
                                dataIndex,
                                key: record.key,
                            });
                        }}
