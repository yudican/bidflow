...
const ModalBillingOrder = ({
  ...
  const onFinish = (value) => {
    ...
    if (productsData.length < 1) {
      return toast.error("Harap Pilih Salah Satu Produk")
    }
        ...
        onClick={() => {
          ...
          const newProduct =
            detail?.product_needs
              ?.filter((value) => value.qty_delivery > 0)
              ?.map((item) => {
                return {
                  id: item.id,
                  ...
                  product_qty: item.qty_delivery - item.qty_dibayar || 0,
                  qty: 0,
                  selected: false,
                }
              }) || []
              ...
              >
                <Select
                  ...
                  onChange={(e) => {
                    ...
                    if (checkbook) {
                      form.setFieldsValue({
                        account_name: checkbook.description,
                        account_bank: checkbook.bank_name,
                        total_transfer: detail.amount,
                      })
                    }
                  }}
                >
            ...
            <div className="col-md-6">
              <Form.Item
                ...
                rules={[
                  ...
                  {
                    pattern: /^[0-9]+$/,
                    message: "Total Transfer harus berupa angka",
                  },
                  {
                    validator: (_, value) =>
                      value && value < 1
                        ? Promise.reject(
                            new Error(
                              "Total Transfer tidak boleh kurang dari 1"
                            )
                          )
                        : Promise.resolve(),
                  },
...
export default ModalBillingOrder
