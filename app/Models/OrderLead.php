...
class OrderLead extends Model
{
    ...
    protected $fillable = ['uid_lead', 'title', 'contact', 'sales', 'customer_need', 'user_created', 'user_updated', 'payment_term', 'brand_id', 'status', 'type_customer', 'warehouse_id', 'order_number', 'invoice_number', 'reference_number', 'shipping_type', 'address_id', 'notes', 'courier', 'status_penagihan', 'status_pengiriman', 'status_invoice', 'due_date', 'kode_unik', 'temp_kode_unik', 'ongkir', 'company_id', 'type', 'status_submit', 'attachment', 'print_status', 'resi_status', 'master_bin_id', 'gp_si_number', 'preference_number', 'status_ethix_submit', 'delivery_date', 'invoice_date', 'expired_at'];

    protected $dates = [];
    protected $appends = ['amount', 'amount_ppn', 'amount_ppn_invoiced', 'total', 'amount_invoiced', 'subtotal', 'subtotal_invoiced', 'tax_amount', 'tax_amount_invoiced', 'discount_amount', 'discount_amount_invoiced', 'contact_name', 'contact_name_only', 'sales_name', 'payment_term_name', 'created_by_name', 'courier_name', 'selected_address', 'amount_billing_approved', 'amount_deposite', 'company_name', 'contact_uid', 'attachment_url', 'warehouse_name', 'total_qty', 'total_qty_delivery', 'total_qty_payment', 'ethix_items', 'payment_due_date', 'gp_numbers'];
    ...
    {
        return $this->amount + $this->ongkir + $this->kode_unik + $this->amount_ppn;
    }
